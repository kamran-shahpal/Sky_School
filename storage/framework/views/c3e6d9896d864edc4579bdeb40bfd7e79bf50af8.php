...
<?php if( in_array(session()->get('user.language', config('app.locale')), config('constants.langs_rtl')) ): ?>
	<link rel="stylesheet" href="<?php echo e(asset('css/rtl.css'), false); ?>">
<?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\Sky_School\resources\views/layouts/partials/css.blade.php ENDPATH**/ ?>